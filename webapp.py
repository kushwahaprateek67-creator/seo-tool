...
if not st.session_state.authenticated:
    ...
    with col_l2:
        password_input = st.text_input("Enter App Password", type="password", placeholder="पासवर्ड दर्ज करें")
        login_button = st.button("Login", use_container_width=True)
        
        # यहाँ अपना पासवर्ड सेट करें (फिलहाल "1234" है)
        CORRECT_PASSWORD = "Prateek@2026" 
    ...
    # ----------------- फ्रेम के अंदर का कंटेंट (सफल लॉगिन के बाद) -----------------
